package dev.gitworktreetools.actions
...
import dev.gitworktreetools.git.WorktreeCacheSnapshot
...
import dev.gitworktreetools.ui.CarryOverResultDialog
import dev.gitworktreetools.ui.CreateWorktreeDialog
import dev.gitworktreetools.ui.RemoveWorktreeDialog
import dev.gitworktreetools.ui.WorktreePickerDialog
...
class OpenWorktreesPanelAction : DumbAwareAction() {
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ToolWindowManager.getInstance(project).getToolWindow("Git Worktree Tools")?.show()
...
class OpenWorktreeAction : DumbAwareAction() {
    override fun actionPerformed(e: AnActionEvent) {
        ...
        chooseWorktree(project, includeMain = false, title = "Open Worktree") { worktree ->
            val mode = resolveMode(project, GitWorktreeToolsSettingsResolver.effective(project).defaultOpenMode)
