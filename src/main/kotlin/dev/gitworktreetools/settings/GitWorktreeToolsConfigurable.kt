...
/** Settings UI under Version Control > Git Worktree Tools for the global defaults and project override. */
class GitWorktreeToolsConfigurable(
    private val project: Project,
) : BoundConfigurable("Git Worktree Tools") {
