...
import dev.gitworktreetools.git.RepositoryScope
...
/**
 * Registers the Git Worktree Tools tool window: hosts the [WorktreesPanel], installs the top-right
...
class WorktreesToolWindowFactory :
    ...
    override fun createToolWindowContent(
        ...
        updateTitle()
        toolWindow.setStripeTitle("Git Worktree Tools")
